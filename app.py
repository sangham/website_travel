...
def vehicles():
    try:
        ...
        return f"Error loading vehicles: {str(e)}", 500
...
def vehicle_detail(vehicle_id):
    try:
        ...
        return f"Error loading vehicle: {str(e)}", 500
...
def vacation_packages():
    try:
        ...
        return render_template('vacation-packages.html', packages=packages_list)
    except Exception as e:
        return f"Error loading packages: {str(e)}", 500
...
def char_dham_yatra():
    try:
        ...
        return f"Error loading Char Dham packages: {str(e)}", 500
...
def blogs():
    try:
        ...
        return f"Error loading blogs: {str(e)}", 500
